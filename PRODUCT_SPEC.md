...
*   **Completion rule**: A workout can be explicitly finished at any time, or automatically finishes when at least half of its exercises are checked. Individual exercise checks remain optional, and the saved summary records their exact completion count. Finished days remain marked through the current four-day program cycle; the next cycle begins cleanly after all four days finish.
